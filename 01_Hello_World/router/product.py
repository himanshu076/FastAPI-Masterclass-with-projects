...
def get_all_products():
  ...
  response.set_cookie(key='test_cookie', value='testcookie_value')
  return response

@router.get('/withheader')
def get_products(response: Response, custom_header: list[str] = Header(default=None),
                 test_cookie: str | None = Cookie(default=None)):
  if custom_header:
